...
class AimToDirectionConstants:
    ...
    kMinTurnSpeed = 0.07  # turning slower than this is unproductive for the motor (might not even spin)
    kAngleToleranceDegrees = 2.0  # plus minus 3 degrees is "close enough"
